...
# ========= CONFIG (EDIT THESE) =========
DATA_PATH   = rf"J:\assпірантура\моя тема\Code\1\Input\PQ.xlsx"  # PQ.xlsx path
MODELS_DIR  = rf"J:\assпірантура\моя тема\Code\1\Models"          # folder with *_best.* and *_best.meta.json
SAVE_DIR    = Path(rf"J:\assпірантура\моя тема\Code\1\Evaluated")   # where to save the Excel workbooks
